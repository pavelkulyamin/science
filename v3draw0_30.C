...
// 10 - 20%
 ...
 const Int_t n1 = 14;
   ...
   TH1D * hist1 = (TH1D*) p_v2->ProfileX("prof",6,9)->Rebin(14,"hist1",bin);
 ...
 TLatex* harmMark = new TLatex(0.06, 0.13, "Au+Au #sqrt{s_{NN}}= 19.6 GeV, 0-30%");
