...
// 10 - 20%
 ...
 const Int_t n1 = 14;
   ...
   TH1D * hist1 = (TH1D*) p_v2->ProfileX("prof",7,7)->Rebin(14,"hist1",bin);
...
pad1->cd();
 ...
 TLatex* harmMark = new TLatex(0.2, 0.22, "Au+Au #sqrt{s_{NN}}= 19.6 GeV, 10-20%");
