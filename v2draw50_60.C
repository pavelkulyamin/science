...
// 10 - 20%
 ...
 const Int_t n1 = 14;
   ...
   Double_t v2pt19gev_st[n1]  = {0.0272,0.0530,0.0779,0.0991,0.1201,0.1359,0.1518,0.1665,0.1870,0.1900,0.1952,0.2054,0.2176,0.2026};
   Double_t pt19err_st[n1] = {0};
   Double_t v2pt19err_st[n1] = {.0014,.0027,.0039,.0050,.0060,.0068,.0076,.0083,.0093,.0095,.0098,.0103,.0109,.0101};
   ...
   TH1D * hist1 = (TH1D*) p_v2->ProfileX("prof",3,3)->Rebin(14,"hist1",bin);
...
pad1->cd();
 ...
 TLatex* harmMark = new TLatex(0.2, 0.22, "Au+Au #sqrt{s_{NN}}= 19.6 GeV, 50-60%");
